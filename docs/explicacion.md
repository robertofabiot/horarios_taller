...
Nota sobre los métodos y comportamientos: Para cumplir con las directrices de arquitectura discutidas en clase, se ha implementado un patrón de modelo de dominio anémico. Por este motivo, las clases documentadas y diagramadas encapsulan únicamente los atributos (estado). Los métodos, lógicas de negocio y comportamientos exigidos por el sistema serán abstraídos y delegados a clases de tipo Service en fases posteriores, manteniendo los modelos limpios.